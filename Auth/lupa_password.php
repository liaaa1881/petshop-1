...
<head>
    ...
    <title>Lupa Password | Petshop Pro</title>
...
<body>
    <div class="reset-card <?php echo $shake_class; ?>">
        ...
        <p class="text-muted small mb-4">Jangan khawatir! Masukkan detail akun Anda untuk verifikasi identitas.</p>

        <form action="proses_lupa_password.php" method="POST" onsubmit="return verifikasiLupaPassword(event)">
            <!-- Username -->
    ...
    <script>
        ...
        function verifikasiLupaPassword(event) {
